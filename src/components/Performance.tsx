...
const Performance: React.FC = () => {
  ...
  useGSAP(
    () => {
      ...
      // 🚫 Skip image animation on mobile
      if (isMobile) return

      // 🟡 Scroll-linked image positioning timeline
    ...
    <section id="performance" ref={sectionRef}>
      ...
      <div className="content">
        <p>
          ...
          imagination. The M4 family of chips features a GPU with a
          second-generation hardware-accelerated ray tracing engine that renders images
          faster, so{' '}
