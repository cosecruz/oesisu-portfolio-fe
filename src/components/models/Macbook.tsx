...
Files: macbook.glb [629.72KB] > /root/Projects/oesisu-portfolio/oesisu-portfolio-fe/public/models/macbook-transformed.glb [627.9KB] (0%)
...
const ModelMacbook: React.FC<JSX.IntrinsicElements['group']> = (props) => {
